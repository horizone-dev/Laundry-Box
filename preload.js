...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  refundDeletedOrder: (options) => ipcRenderer.invoke('refund-deleted-order', options),
  ...
  runDataHealer: (customerId) => ipcRenderer.invoke('run-data-healer', customerId),
  getFinancialAudit: (customerId) => ipcRenderer.invoke('audit-financial-integrity', customerId),
  getCustomerFinancialState: (customerId) => ipcRenderer.invoke('get-customer-financial-state', customerId),
  settleCustomerBalance: (payload) => ipcRenderer.invoke('settle-customer-balance', payload),
  ...
  getPaginatedTransactions: (options) => ipcRenderer.invoke('get-paginated-transactions', options),
});
