      ...
      try {
        ...
        if (result.success && result.data.length > 0) {
          ...
          setSettings({
            ...
            country: shopSettings?.country || 'United Arab Emirates',
            cityAr: shopSettings?.cityAr || '',
            emirateAr: shopSettings?.emirateAr || 'دبي',
            countryAr: shopSettings?.countryAr || 'الإمارات العربية المتحدة',
            ...
            invoiceShowArabicServiceName: shopSettings?.invoiceShowArabicServiceName ?? true,
            invoiceShowPaymentDetails: shopSettings?.invoiceShowPaymentDetails ?? true,
            ...
            invoiceFooterTagline: shopSettings?.invoiceFooterTagline || '',
            invoiceAccentColor: shopSettings?.invoiceAccentColor || '#2563EB',
    ...
    if (electronAPI?.dbQuery) {
      ...
      try {
        const settingsJson = JSON.stringify({
          ...
          cityAr: updated.cityAr,
          emirateAr: updated.emirateAr,
          countryAr: updated.countryAr,
          taxId: updated.taxId,
          trn: updated.trn,
          ...
          invoiceShowPaymentDetails: updated.invoiceShowPaymentDetails,
          ...
          invoiceFooterTagline: updated.invoiceFooterTagline,
          invoiceAccentColor: updated.invoiceAccentColor,
          invoiceFontSize: updated.invoiceFontSize,
          paymentMethodCashEnabled: updated.paymentMethodCashEnabled,
          paymentMethodCardEnabled: updated.paymentMethodCardEnabled,
          paymentMethodUpiEnabled: updated.paymentMethodUpiEnabled,
          ...
          zReportAutoCloseEnabled: updated.zReportAutoCloseEnabled,
          zReportAutoCloseTime: updated.zReportAutoCloseTime,
        });
