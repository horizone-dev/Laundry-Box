      ...
      <div className={styles.statementCard}>
        <div className={styles.header}>
          <div className={styles.shopInfo}>
             <img src={settings.logo || defaultLogo} alt="" className={styles.logo} onError={(e) => e.target.style.display='none'} />
             <div className={styles.shopDetails}>
                <h2>{settings.shopName || 'Laundry Box'}</h2>
        ...
        <div className={styles.watermark}>Generated by Laundry Box</div>
      </div>
    </div>
  );
}
